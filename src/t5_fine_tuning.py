...
if __name__ == '__main__':
    ...
    sample_text = [
        f'Deep Learning models have achieved state-of-the-art performance across various NLP benchmarks. '
        f'However, summarizing long documents remains a challenge due to limited context'
        f'windows and dependencies on fine-grained linguistic information.'
    ]
